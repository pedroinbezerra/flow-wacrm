...
export function MessageActions({
  ...
  return (
    ...
    >
       ...
       *  area. See issue #165. */}
      <div
        className="group/actions relative min-w-0 max-w-[75%]"
        onClick={() => setTouchOpen((prev) => !prev)}
      >
        {children}
      <div
      ...
      >
        <EmojiPickerPopover
          ...
          triggerClassName="flex h-5 w-5 items-center justify-center rounded-full text-popover-foreground hover:bg-muted hover:text-foreground"
        />
