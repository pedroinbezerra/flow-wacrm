...
export function ContactDetailView({
  ...
  async function saveDetails() {
    ...
    if (error) {
      toast.error(t('contacts.detail.failedUpdate'));
    } else {
      toast.success(t('contacts.detail.successUpdate'));
      fetchContact();
      onUpdated();
    }
  ...
  async function addNote() {
    ...
    if (error) {
      toast.error(t('contacts.detail.failedAddNote'));
    } else {
      setNewNote('');
      fetchNotes();
  ...
  async function deleteNote(noteId: string) {
    ...
    if (error) {
      toast.error(t('contacts.detail.failedDeleteNote'));
    } else {
  ...
  async function saveCustomFields() {
    ...
    try {
      ...
      toast.error(t('contacts.detail.failedSaveCustom'));
    }
              ...
              <TabsContent value="tags" className="flex-1 overflow-y-auto px-4 py-3">
                <div className="space-y-3">
                  <p className="text-xs text-muted-foreground">
                    {t('contacts.detail.clickToAddRemove')}
                  </p>
                  {allTags.length === 0 ? (
              ...
              <TabsContent value="notes" className="flex-1 flex flex-col min-h-0 px-4 py-3">
                <div className="space-y-2 mb-3">
                  <Textarea
                    ...
                    placeholder={t('common.placeholders.writeNote')}
                    ...
                    {customFields.map((field) => (
                      <div key={field.id} className="space-y-1.5">
                        ...
                        <Input
                          ...
                          placeholder={t('contacts.detail.customFieldPlaceholder', {
