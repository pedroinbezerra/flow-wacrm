...
const getContactFields = (t: ReturnType<typeof useTranslation>['t']) => [
  { value: 'name', label: t('broadcasts.contactFieldName') },
  { value: 'phone', label: t('broadcasts.contactFieldPhone') },
  { value: 'email', label: t('broadcasts.contactFieldEmail') },
  { value: 'company', label: t('broadcasts.contactFieldCompany') },
];
...
export function Step3Personalize({
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-foreground">{t('broadcasts.personalizeTitle')}</h2>
        <p className="mt-1 text-sm text-muted-foreground">
          {t('broadcasts.personalizeDescription')}
        </p>
      </div>
      ...
      {placeholders.length === 0 ? (
        <div className="rounded-xl border border-border bg-card/50 p-6 text-center">
            ...
            {t('broadcasts.noPersonalizationNeeded')}
          </p>
        </div>
      ) : (
                  ...
                  <div>
                    ...
                    {mapping.type === 'static' ? (
                      <Input
                        ...
                        placeholder={t('broadcasts.enterValue')}
      ...
      {unmappedKeys.length > 0 && (
        <div className="rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-2 text-xs text-amber-300">
          {t('broadcasts.missingPlaceholdersPrefix')}{' '}
          <span className="font-mono font-semibold">
            {unmappedKeys.join(', ')}
          </span>
          {t('broadcasts.missingPlaceholdersSuffix')}
        </div>
      )}
